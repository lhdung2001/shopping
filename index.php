					...
					<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
						...
						<div id="hero" class="homepage-slider3">
							<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
								...
								<div class="full-width-slider">
									<div class="item full-width-slider" style="background-image: url(assets/images/sliders/2.webp);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->
								...
								<div class="row">
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">free ship-on oder over 1.000.000đ</h6>
										</div>
									</div><!-- .col -->
												...
												<div class="product">
													...
													<div class="product-info text-left">
														...
														<div class="product-price">
															...
															<span class="price-before-discount"><?php echo htmlentities(number_format($row['productPriceBeforeDiscount']).""); ?> </span>
											...
											<div class="row product-micro-row">
												...
												<div class="col col-xs-6">
													<div class="product-info">
														...
														<div class="product-price">
															<span class="price">
																<?php echo htmlentities(number_format($row['productPrice']).""); ?>
															</span>
