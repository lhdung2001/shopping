							...
							?>
										...
										<div class="cart-item product-summary">
											<div class="row">
												...
												<div class="col-xs-7">
													...
													<div class="price"><?php echo number_format(($row['productPrice'] + $row['shippingCharge']).""); ?>đ*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
												</div>
								...
								<div class="clearfix cart-total">
									<div class="pull-right">
										...
										<span class="text">Total :</span><span class='price'><?php echo number_format($_SESSION['tp'] = "$totalprice").""; ?>đ</span>
